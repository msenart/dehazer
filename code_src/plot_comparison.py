...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_root", required=False,
                        default=r"C:\Users\22863\Desktop\git\ima1\ima_projet\dehazer\code_src\complet_dehazer\seriespicturesoutput",
                        help="root folder containing parameter subfolders")
    parser.add_argument("--out_dir", required=False,
                        default=r"C:\Users\22863\Desktop\git\ima1\ima_projet\dehazer\code_src\complet_dehazer\seriespicturesoutput\plots",
